// Central inline-SVG icon set for the public portal. PLAN §2 lists lucide-react,
// but it is not installed; rather than add a dependency we keep one small icon
// map here so no SVG markup is duplicated across Navbar / BottomNav / cards.
// Pure markup — safe in both server and client components.

// Stroke-style icons (outline). Value is the inner <path> markup.
const STROKE = {
  home: '<path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />',
  ...
  share: '<path stroke-linecap="round" stroke-linejoin="round" d="M8.684 10.742l5.428-2.714m0 5.942l-5.428-2.714m8.572-5.486a3 3 0 11-6 0 3 3 0 016 0zm-8.572 6a3 3 0 11-6 0 3 3 0 016 0zm8.572 6a3 3 0 11-6 0 3 3 0 016 0z" />',
  ...
  document: '<path stroke-linecap="round" stroke-linejoin="round" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />',
  ...
  filter: '<path stroke-linecap="round" stroke-linejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-.293.707L15 12.414V19a1 1 0 01-.553.894l-4 2A1 1 0 019 21v-8.586L3.293 6.707A1 1 0 013 6V4z" />',
  ...
  link: '<path stroke-linecap="round" stroke-linejoin="round" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5m9.656-1.328a4 4 0 00-5.656 0l-3 3" />',
  ...
  tag: '<path stroke-linecap="round" stroke-linejoin="round" d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 11V6a3 3 0 013-3z" />',
  ...
  type: '<path stroke-linecap="round" stroke-linejoin="round" d="M4 7V5a1 1 0 011-1h14a1 1 0 011 1v2M9 20h6M12 4v16" />',
  users: '<path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-2.13a4 4 0 10-4-4 4 4 0 004 4zm6 0a4 4 0 00-1-7.75" />',
  ...
  globe: '<path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3.6 9h16.8M3.6 15h16.8M12 3a15 15 0 010 18 15 15 0 010-18z" />',
...
// Solid/brand icons (filled). Value is the inner markup; rendered with fill.
const FILL = {
  ...
  if (FILL[name]) {
    return (
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        dangerouslySetInnerHTML={{ __html: FILL[name] }}
      />
    )
  }
  const path = STROKE[name] || STROKE.menu
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
